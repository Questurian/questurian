...
export default function ElComercioCard({
  categoryFilter,
  lookups,
  post,
  showTranslated,
  ...
  const categoryName =
    lookups.categoryNames.get(
      lookups.elComercioFeedCategoryIds.get(post.el_comercio_feed_id),
    ) ||
    categoryFilter ||
    'Unknown';
  ...
  return (
    <article className="lead-card lead-card-el-comercio">
      {post.image_url && (
      ...
      <div className="lead-badges">
        ...
        <span className="badge">
          {lookups.elComercioFeedNames.get(post.el_comercio_feed_id) || 'Unknown Feed'}
        </span>
