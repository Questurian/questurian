...
console.log('    bun run dev           Start uvicorn server (port 4004)')
console.log('    bun run dev:clean     Kill port + pip install + start')
console.log('')
console.log('  Docker (LibreTranslate):')
console.log('    bun run docker:start  Start LibreTranslate on port 5001')
console.log('    bun run docker:stop   Stop LibreTranslate container')
console.log('    bun run docker:logs   View LibreTranslate logs')
console.log('')
