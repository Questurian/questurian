...
interface LocationDetailReviewStackProps {
...
export function LocationDetailReviewStack({
  locationDetail,
  onCopyField,
}: LocationDetailReviewStackProps) {
    ...
    <div className="mt-4 pt-4 border-t border-border">
      <div className="space-y-3">
        ...
        {locationDetail.title && locationDetail.title !== locationDetail.source?.name && (
          <DetailField label="Title" value={locationDetail.title} />
        )}
