"""Editorial block markers, metadata boxes, labels, and blueprint formatting.
...
__all__ = [
    ...
    "_normalize_editorial_component_name",
    "_normalize_markdown_for_comparison",
    "_editorial_box_marker",
    "_editorial_block_start_marker",
    "_editorial_block_end_marker",
    "_editorial_block_label_marker",
    "_line_matches_editorial_marker",
    "_find_editorial_block_range",
    "_content_has_editorial_block",
    "_build_editorial_metadata_box",
    "_wrap_existing_editorial_box_with_markers",
    "_ensure_editorial_block_labels",
    "_ensure_editorial_component_boxes",
]
