...
Structure: sentence case headings, no one-sentence sections, lists only for parallel items, and a closing takeaways section that synthesises the decisions the article already supported, in fresh wording rather than copied sentences, and never introduces a fact or place the body did not cover.
