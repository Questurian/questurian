...
export const DEFAULT_ITINERARY_TITLE_MODEL: ItineraryTitleModelName = 'gemini-2.5-flash'
...
export const ITINERARY_TITLE_MODEL_OPTIONS: Array<{
  ...
  { value: 'gemini-2.5-pro', label: 'Gemini 2.5 Pro (deep reasoning; several times the cost)' },
]
