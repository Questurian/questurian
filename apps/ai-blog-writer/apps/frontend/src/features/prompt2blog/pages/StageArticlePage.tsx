      ...
      try {
        ...
        if (stagedId) {
          ...
          if (existing) {
            ...
            navigate(`/prompt2blog/stage-article?stagedId=${existing.id}`, { replace: true })
          } else {
            ...
            navigate(`/prompt2blog/stage-article?stagedId=${newStaged.id}`, { replace: true })
          }
        }
      } catch (err) {
        if (!isCancelled) {
    ...
    return (
      <div className="stage-article-page">
        <div className="stage-article-error">
          <h2>Error</h2>
          <p>{error}</p>
          <Link to="/prompt2blog/articles" className="stage-article-btn">Back to Articles</Link>
        </div>
      </div>
    )
  }
    ...
    <div className="stage-article-page">
      ...
      <header className="stage-article-header">
        <div className="stage-article-header-left">
          <Link to="/prompt2blog/stage" className="stage-article-back-link">
