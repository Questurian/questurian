  ...
  return (
    <div className="stage-page">
      ...
      {stagedArticles.length === 0 ? (
        <div className="stage-empty-state">
          ...
          <p className="stage-hint">
            Go to <Link to="/prompt2blog/articles">Saved Articles</Link> and click "Stage for Payload" to add articles here.
          </p>
        </div>
      ) : (
        <div className="stage-list">
          {stagedArticles.map(article => {
            ...
            return (
              <Link
                key={article.id}
                to={`/prompt2blog/stage-article?stagedId=${article.id}`}
      ...
      <div className="stage-footer">
        <Link to="/prompt2blog/articles" className="stage-btn">
