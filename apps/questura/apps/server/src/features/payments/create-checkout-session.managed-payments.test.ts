...
describe('create checkout session with Managed Payments', () => {
  ...
  const BEFORE_PLAIN =
    '[{"customer":"cus_123","mode":"subscription","line_items":[{"price":"price_123","quantity":1}],"payment_method_types":["card","link"],"success_url":"http://localhost:3000/subscription/success?session_id={CHECKOUT_SESSION_ID}&returnTo=%2Faccount","cancel_url":"http://localhost:3000/subscription/cancel","metadata":{"visitorAuthUserId":"visitor_123"},"allow_promotion_codes":false,"billing_address_collection":"auto","subscription_data":{"metadata":{"visitorAuthUserId":"visitor_123"}}},{"idempotencyKey":"checkout:7dd54457d9e5f7dc4ac504c57cae00303c8cd195c564474059993dab2e9ef6b8"}]'
  const BEFORE_EVERY_SWITCH =
    '[{"customer":"cus_123","mode":"subscription","line_items":[{"price":"price_yearly_123","quantity":1}],"payment_method_types":["card","link"],"success_url":"http://localhost:3000/subscription/success?session_id={CHECKOUT_SESSION_ID}&returnTo=%2Fperu%2Flima","cancel_url":"http://localhost:3000/subscription/cancel","metadata":{"visitorAuthUserId":"visitor_123","endorsely_referral":"ref_abc123"},"allow_promotion_codes":true,"billing_address_collection":"auto","subscription_data":{"metadata":{"visitorAuthUserId":"visitor_123","endorsely_referral":"ref_abc123"}},"payment_method_options":{"card":{"request_three_d_secure":"challenge"}}},{"idempotencyKey":"checkout:cf59306f868ee9f949c0d1bf0ccdc55bfbf14820d93c2ef1c8f5f09f3f4cb985"}]'
