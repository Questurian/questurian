 ...
 *
 * Manages the multi-step form workflow for Itineraries.
...
const Step1Wrapper = (props: FieldProps) => {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      {/* Confirmation dialog for clearing items when location changes */}
      {showConfirmDialog && pendingChange && (
        <div className={styles.modal}>
          <div className={styles.modalContent}>
            <h3>Clear Itinerary Items?</h3>
            <p>
              Changing the location will clear all itinerary items you've added. Continue?
            </p>
