...
export function MembershipBillingInfo({ billingInfo }: MembershipBillingInfoProps) {
  return (
    <div className="bg-white border border-[#e5e2dc] rounded-sm p-3 480:p-4 mb-4">
      <h4 className="text-[0.8rem] 480:text-[0.84rem] font-medium text-[#1A1A1A] mb-2">Billing Information</h4>
      <div className="space-y-1.5 text-[0.8rem] 480:text-[0.82rem] text-[#6b6a68]">
